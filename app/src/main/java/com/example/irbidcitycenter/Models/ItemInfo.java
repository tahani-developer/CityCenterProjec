...
public class ItemInfo {
    ...
    public String getLASTSPRICE() {
        return LASTSPRICE;
    }

    public void setLASTSPRICE(String LASTSPRICE) {
        this.LASTSPRICE = LASTSPRICE;
    }

    public String getBUYERGGROUP() {
        return BUYERGGROUP;
    }

    public void setBUYERGGROUP(String BUYERGGROUP) {
        this.BUYERGGROUP = BUYERGGROUP;
    }
